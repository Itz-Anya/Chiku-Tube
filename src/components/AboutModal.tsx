      ...
      {open && (
        ...
        >
          <motion.div
            ...
            className="relative my-8 w-full max-w-lg overflow-hidden rounded-3xl border border-border/60 bg-card shadow-elevated"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Decorative gradient header */}
            <div className="relative overflow-hidden bg-gradient-to-br from-primary/30 via-fuchsia-500/20 to-amber-400/20 px-6 pb-12 pt-10">
              ...
              <div className="relative flex flex-col items-center text-center">
                <motion.img
                  ...
                  className="h-55 w-auto drop-shadow-[0_8px_24px_rgba(124,58,237,0.45)]"
                />
