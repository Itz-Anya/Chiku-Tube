  ...
  return (
    <header className="sticky top-0 z-40 border-b border-border/60 bg-background/80 backdrop-blur-xl">
      <div className="mx-auto flex h-16 max-w-[1600px] items-center gap-3 px-4 sm:gap-6 sm:px-6">
        ...
        >
          <img src="/chiku-t.png" alt="Chiku Tube" className="h-9 w-auto" />
        </button>
        ...
        <form onSubmit={onSubmit} className="flex flex-1 items-center justify-center">
          <div className="relative w-full max-w-xl">
            ...
            <input
              ...
              className="h-11 w-full rounded-full border border-border bg-surface pl-11 pr-11 text-sm text-foreground shadow-soft outline-none transition-all placeholder:text-muted-foreground focus:border-ring focus:ring-2 focus:ring-ring/30"
            />
            {q && (
              <button
                type="button"
